...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⢛⠙⠉⠙⠋⠉⠉⠀⠀⠀⠀
    ...
    table.add_row("playercheck", "<player> → Check info about a player")
    table.add_row("botsjoining", "<serverip>:<server_port>:<bot_amount>:<bot_name>:<timein> → Join bots to a server")
    table.add_row("checkpassword", "<serverip>:<server_port>:<version>:<name>:<password> → Check a password in a server")
    table.add_row("checksubdomains", "<domain> → Bruteforce domains")
